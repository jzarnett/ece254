...
We might give an estimate of $S_{1} = 0$ to start with, which gives new priorities a process and a chance to get started. After they have started and run a bit, we will have some data. But first we have to give them a chance.

...
That still applies. Aside from intentionally depriving the system of RAM, how can we get into this state, and how can we get out of it?
...
magine that you have moved to a new city for a co-op term. 

...
There additional desirable properties that will be used to evaluate any solution:
\begin{itemize}
...
In the original paper, \texttt{wait} was called \texttt{P} and \texttt{wait} was called \texttt{V}, but the names in common usage have become a little more descriptive. 
